...
<br />
<br />
<button class="text-button" type="button" id="mhr">Before Conte Heart Rates</button>
<br />
<br />
<button class="text-button" type="button" id="rat_dti">Rat DTI Segmentations</button>
<br />
<br />
<button class="text-button" type="button" id="rat_struct">Rat Structural Segmentations</button>
<br />
<br />
          </div>
